...
d <- data.frame('n' = round(c(n0, n1), 2), "cancer_per_100k" = round(c(ev0, ev1), 2),
                'mhat' = c(m1, m0), 'shat' = round(c(s, s), 2), 
...
**`n` is in 100,000 'person years',** one year of life for a person in the group. Think of this as one observation. `shat` values are $\hat{s}_{n_0}$ and $\hat{s}_{n_1}$ used in the calculation of $\hat{s}_{n_1, n_0}$. `shat_mean` is `shat` / `sqrt(n)`.
